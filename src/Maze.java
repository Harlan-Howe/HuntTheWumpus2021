...
public class Maze {
	...
	public Maze()
	{
		...
		// Note: you may find it handy to create an array of 20 arrays of three ints each:
		//            int [][] room_links = {{0,0,0},  {0,0,0}, ...};
		//       Obviously, you don't want all zeros. This array of arrays should only be used in the constructor to
		//          set up the rooms.
